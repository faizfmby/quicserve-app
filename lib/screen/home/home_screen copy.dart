...
class _HomeScreenState extends State<HomeScreen> with TickerProviderStateMixin {
  ...
  void _addSuggestedItem(String itemTitle) {
    // Find the MenuItem object that matches the suggested title
    ...
    // Clear the suggestion immediately after adding, whether successful or not
    setState(() {
      _suggestedItem = null;
    });
  }
      ...
      children: [
        ...
        Expanded(
          ...
          child: OrderSection(
            ...
            suggestedItem: _suggestedItem,
            onAddSuggestedItem: _addSuggestedItem,
            isBlur: isBlur,
            subTotal: _subTotal,
            total: _total,
            onCreateOrder: _createOrder,
            onDeleteOrderItem: _handleDeleteOrderItem,
